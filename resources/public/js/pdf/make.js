...
target.firefox = function() {
  ...
  target.locale();
  target.bundle({ excludes: ['foundation/network.js'], defines: defines });
  cd(ROOT_DIR);
  ...
  var setup = {
    ...
    preprocess: [
      ...
      [SRC_DIR + 'foundation/network.js', FIREFOX_BUILD_CONTENT_DIR],
...
target.mozcentral = function() {
  ...
  var setup = {
    ...
    preprocess: [
      ...
      [SRC_DIR + 'foundation/network.js', MOZCENTRAL_CONTENT_DIR],
